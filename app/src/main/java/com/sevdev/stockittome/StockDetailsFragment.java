...
public class StockDetailsFragment extends Fragment {
    ...
    public void setTwoPaneView( String symbol){
        Stock paneStock = ioHelper.getStockBySymbolKey(symbol);
        companyText.setText(paneStock.getCompanyName());
        priceText.setText("$"+paneStock.getCurrentPrice());
        showStockChart(symbol);
    }
